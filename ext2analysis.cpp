...
Ext2Analysis::Ext2Analysis()
  : m_fd(0)
{
}

Ext2Analysis::Ext2Analysis(const char* filename)
  : m_fd(0)
{
  open(filename);  
}

int Ext2Analysis::_read_super_block()
{
  int ret = 0;
...
int Ext2Analysis::_read_group_descs(const ext_super_block& super)
{
  _byte* buf = 0;
...
bool Ext2Analysis::open(const char* filename)
{
...
int Ext2Analysis::get_inode_bitmap(_dword group_num,
				   _byte* bitmap,
				   size_t size)
{
...
// by group dsecriptor and super block.
int Ext2Analysis::get_block_bitmap(_dword group_num,
				  _byte* bitmap,
				  size_t size)
{
...
void Ext2Analysis::get_used_bits(const _byte* bitmap, size_t size, vector<_dword>& used_bits)
{
...
int Ext2Analysis::get_inodes(_dword group_num, vect_inodes& inodes)
{
...
i_node Ext2Analysis::get_inode(_dword ino)
{
